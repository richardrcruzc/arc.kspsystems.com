...
namespace Nop.Plugin.Widgets.GoDaddyApi.Infrastructure.Cache
{
    /// <summary>
        ...
        IConsumer<EntityDeleted<Setting>>
    {
        ...
        /// {0} : picture id
        /// </remarks>
        public const string PICTURE_URL_MODEL_KEY = "Nop. Nop.Plugin.Widgets.GoDaddyApi.pictureurl-{0}";
        public const string PICTURE_URL_PATTERN_KEY = "Nop. Nop.Plugin.Widgets.GoDaddyApi";
