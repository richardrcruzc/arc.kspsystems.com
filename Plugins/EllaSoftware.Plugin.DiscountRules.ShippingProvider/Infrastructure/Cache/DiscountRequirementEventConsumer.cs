using EllaSoftware.Plugin.DiscountRules.ShippingProvider;
using Nop.Core.Domain.Discounts;
using Nop.Core.Events;
using Nop.Services.Configuration;
using Nop.Services.Events;

namespace EllaSoftware.Plugin.DiscountRules.ShippingProdiver.Infrastructure.Cache
{
    /// <summary>
    ...
    public partial class DiscountRequirementEventConsumer : IConsumer<EntityDeleted<DiscountRequirement>>
    {
        ...
        public void HandleEvent(EntityDeleted<DiscountRequirement> eventMessage)
        {
            ...
            setting = _settingService.GetSetting(string.Format(DiscountRequirementDefaults.TypeNameSettingsKey, discountRequirement.Id));
            if (setting != null)
                _settingService.DeleteSetting(setting);
