...
using Nop.Plugin.DiscountRulesShippingType.Models;
...
namespace Nop.Plugin.DiscountRulesShippingType.Controllers
{
    [AuthorizeAdmin]
    [Area(AreaNames.Admin)]
    public class ShippingTypeController : BasePluginController
    {
        #region Fields
        ...
        public ShippingTypeController(ICustomerService customerService,
