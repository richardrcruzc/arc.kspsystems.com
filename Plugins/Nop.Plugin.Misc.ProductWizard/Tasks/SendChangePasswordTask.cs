...
using ILanguageService = Nop.Services.Localization.ILanguageService;

namespace Nop.Plugin.Misc.ProductWizard.Tasks
{
    public partial class    SendChangePasswordTask: IScheduleTask
    {
        ...
        public SendChangePasswordTask(ICustomerService customerService,
